...
## 4. Introducción a Valores Atípicos (*Outliers*)

Para la próxima sesión, el pipeline de preparación concluye con la auditoría de valores atípicos:
* **¿Qué es un Outlier?:** Una observación que se encuentra a una distancia anormal de las demás instancias.
* **Causas:** Errores de captura humana, fallas mecánicas de hardware, eventos raros pero legítimos (fraudes bancarios, terremotos).
* **Impacto:** Destruyen la media y la varianza, distorsionan el escalado Z-Score y desvían los hiperplanos de las Redes Neuronales.
