...
$$n = \frac{R_{\text{nuevo}}}{R_{\text{antiguo}}} = \frac{T_{\text{antiguo}}}{T_{\text{nuevo}}} = \frac{40\text{ min}}{32\text{ min}} = \frac{5}{4} = \mathbf{1.25}$$

El programa optimizado es **$1.25$ veces más rápido** que la versión anterior.

#### Paso 2: Calcular el Porcentaje de Mejora de Rendimiento
$$\% \text{ Mejora de Rendimiento} = (n - 1) \times 100\%$$
$$\% \text{ Mejora} = (1.25 - 1) \times 100\% = 0.25 \times 100\% = \mathbf{25.0\%}$$
...
> | :--- | :---: | :---: | :--- |
> | **Mejora de Rendimiento (Correcta)** | $(n - 1) \times 100\% = \left(\frac{T_{\text{antiguo}}}{T_{\text{nuevo}}} - 1\right) \times 100\%$ | **$+25.0\%$** | La capacidad de procesamiento de la máquina para esta tarea creció una cuarta parte ($1.25\times$). |
